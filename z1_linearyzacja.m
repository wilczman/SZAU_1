...
while t<timespan %wykonuj na przedziale [0,15]
    k11=lin_dv1dt(V1(t),V2(t),F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero); %obliczanie wspó³czynników k dla obu zmiennych 
    k12=lin_dv2dt(V1(t),V2(t),F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k21=lin_dv1dt(V1(t)+0.5*h*k11,V2(t)+0.5*h*k12,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k22=lin_dv2dt(V1(t)+0.5*h*k11,V2(t)+0.5*h*k12,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k31=lin_dv1dt(V1(t)+0.5*h*k21,V2(t)+0.5*h*k22,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k32=lin_dv2dt(V1(t)+0.5*h*k21,V2(t)+0.5*h*k22,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k41=lin_dv1dt(V1(t)+h*k31,V2(t)+h*k32,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
    k42=lin_dv2dt(V1(t)+h*k31,V2(t)+h*k32,F1,Fd,alfa1,alfa2,C1,C2,v1zero,v2zero);
